...
\void
\stmnt{Утв} (критерий нормальности, использующий сопряжение) 
...
\void
\stmnt{Утв} (критерий нормальности, использующий ядро гом-ма) $H\normin G \Leftrightarrow H = \ker{f}$, где $f$ - любой гомоморфизм.
...
\void\stmnt{Зам} Все внутренние автоморфизмы образуют группу
$Inn(G)$. Она является подгруппой $Aut(G)$.

\void\stmnt{Зам} Если G - абелева, то $Inn(G) - \{e\}$.
...
\void\stmnt{Утв} $G/Z(G) \cong Inn(G)$.

\void $\square$

\numsec{1} Если G - абелева, то, очевидно, $G/Z(G) = G/G\cong Inn(G) = \{e\}$;

\numsec{2} Пусть G не абелева. Рассмотрим отображение $f: G\rightarrow Aut(G)$,
